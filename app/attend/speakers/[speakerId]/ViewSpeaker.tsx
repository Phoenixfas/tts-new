...
export default function ViewSpeaker() {
  ...
  return (
    <div className="w-full min-h-screen md:h-screen flex flex-col md:flex-row bg-gradient-to-br from-[#050752] to-[#4EAEE5]">
        <div className="group relative w-full md:w-1/2 h-1/3 md:h-full">
        ...
        <div className="w-full md:w-1/2 h-2/3 md:h-full flex flex-col py-10 md:py-40 px-5 md:px-20">
