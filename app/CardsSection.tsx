...
export default function CardsSection() {
  return (
    <div className='relative flex flex-col items-center gap-10 py-10'>
        <h2 className='text-5xl text-white'>Explore Tech Talent for Events</h2>
        <div className="flex flex-col gap-4 max-w-[1080px]">
            <div className="flex gap-4 w-full">
                <div className="group w-[360px] h-[420px] flex flex-col items-center rounded-lg overflow-hidden text-white text-center">
            ...
            <div className="flex gap-4 w-full">
                <div className="group flex-1 h-[420px] flex flex-col items-center rounded-lg overflow-hidden text-white text-center">
                    <div className="w-full h-[230px] group-hover:h-[210px] duration-300 overflow-hidden">
