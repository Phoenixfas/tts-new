...
export default function HeroContent() {
  ...
  return (
    <div className='relative w-full h-screen flex flex-col items-center sm:items-center justify-center px-5 sm:px-10 md:px-20 pt-20 sm:pb-20'>
        <h1 className='max-w-[90%] text-[2.4rem] leading-[2.5rem] sm:text-6xl md:text-[5rem] md:leading-7xl text-center sm:text-center font-bold mb-10 text-white drop-shadow-[0_0_10px_#78e0f4]'>EXPERIENCE THE BIGGEST <span className='bg-clip-text text-transparent bg-gradient-to-bl from-[#4eaee5] to-[#78e0f4] drop-shadow-[0_0_10px_#050752] mokoto-mark font-normal '>TECH TRADE SHOW</span> LIKE NEVER BEFORE</h1>
        <p className='text-gray-200 text-lg mokoto'>Millennium Hall, May 15-17, 2025</p>
