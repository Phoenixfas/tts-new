  ...
  return (
    <div className='relative w-full h-screen flex flex-col justify-end px-20 py-20'>
        ...
        <div className="w-fit flex gap-2 rounded-full p-2 border border-[#78e0f4] bg-[linear-gradient(to_bottom_right,_#050752,_#4EAEE5)] mb-5">
            <Link href={"/"} className="py-2 px-5 rounded-full border border-[#78e0f4] bg-[#78e0f4] text-[#050752] hover:text-[#78e0f4] hover:bg-[#050752] duration-300">Explore All Talent</Link>
            <Link href={"/"} className="py-2 px-5 rounded-full text-[#78e0f4] hover:text-[#050752] hover:bg-[#78e0f4] duration-300">Exhibitors</Link>
            <Link href={"/"} className="py-2 px-5 rounded-full text-[#78e0f4] hover:text-[#050752] hover:bg-[#78e0f4] duration-300">Media Partners</Link>
            <Link href={"/"} className="py-2 px-5 rounded-full text-[#78e0f4] hover:text-[#050752] hover:bg-[#78e0f4] duration-300">Speakers</Link>
            <Link href={"/"} className="py-2 px-5 rounded-full text-[#78e0f4] hover:text-[#050752] hover:bg-[#78e0f4] duration-300">Magicians</Link>
        </div>
