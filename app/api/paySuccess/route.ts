...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        let mailDetails = {
            ...
            <body>
                <div class="container">
                    ...
                    <div class="welcome">
                        <p>Dear, ${body.first_name + " " + body.last_name} <br>
                    ...
                    <div class="ticket">
                        ...
                        <div class="ticket-l">
                            ...
                            <p><b>Full Name:</b> ${body.first_name + " " + body.last_name}</p>
        ...
        return NextResponse.json(`Error in pay success: ${error.message}`, { status: 400 });
    }
}