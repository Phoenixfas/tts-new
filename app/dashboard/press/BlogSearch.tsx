...
export default function BlogSearch() {
    ...
    const { data, loading, error } = useFetch('press');
    ...
    const handleSearch = (e: any) => {
        ...
        setFilteredData( data.filter((article: any) => article.snippet.toLowerCase().includes(keyword.toLowerCase())))
        setWord(keyword)
