  ...
  return (
    <div className='relative' >
        <div className='p-4 h-[40px] bg-[#ccc] flex items-center gap-3 rounded-full'>
            <input  id='blog-search' className='bg-transparent border-none outline-none text-sm placeholder:text-gray-500 w-[250px] top-section-search' type="text" placeholder='Search Company Name' value={word} onChange={(e) => {
                handleSearch(e)
                checkEmpty(e)
